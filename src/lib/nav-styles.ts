...
export const navStyles = {
  // Shared appearance for both mobile and desktop panels
  panel: "glass-card border-white/10 overflow-hidden bg-black/40 backdrop-blur-[32px] transition-all duration-500",
  
  // Specific layout for the persistent desktop sidebar
  sidebarLayout: "relative flex flex-col p-6 z-40 h-full border-none",
  ...
  // Branding typography and separators
  branding: {
